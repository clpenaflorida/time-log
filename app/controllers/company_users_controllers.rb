class CompanyUsersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @company_user.update(company_params)
        format.html { redirect_to @company_user, notice: 'Company was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to company_users_url, notice: 'Company was successfully destroyed.' }
  ...
  private
    ...
    def company_users_params
      params.require(:company).permit(:name, :domain, :id)
    end
end